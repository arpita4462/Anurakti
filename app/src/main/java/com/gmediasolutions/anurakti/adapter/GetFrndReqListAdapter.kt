 ...
 */
class GetFrndReqListAdapter(
    val friendreqList: List<GetFRndReqModelData>?,
    val rowLayout: Int,
    val context: Context,
    listeners: FrindlistAdapterListener
) : RecyclerView.Adapter<GetFrndReqListAdapter.FriendListViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GetFrndReqListAdapter.FriendListViewHolder {
    ...
    class FriendListViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        fun bind(frindlists: GetFRndReqModelData, position: Int) {
            ...
            itemView.setOnClickListener {
                ...
                frndlistintent.putExtra("frnd_id", frindlists.userId)
